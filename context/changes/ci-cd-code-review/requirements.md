# Requirements: AI code review in CI/CD

> Source: the user's own requirements for M5-L3 workstream B, written before any research.
> Placed verbatim from `.claude/prompts/m5l3-requirements.md` on 2026-09-10 — this file is
> the input to `/10x-research ci-cd-code-review`, not an output of it.
